Action()
{
	...
	web_set_user("denis", 
		lr_unmask("65f1b6b40269ef42012e"), 
		"54.157.232.206:80");

	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710338910.42.1.1710339580.0.0.0; DOMAIN=54.157.232.206");

	web_add_cookie("_ga=GA1.1.1055678014.1708799449; DOMAIN=54.157.232.206");

	web_add_cookie("_ga_56EMNRF2S2=GS1.1.1710338911.38.1.1710338928.43.0.0; DOMAIN=54.157.232.206");
	...
	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710338910.42.1.1710339621.0.0.0; DOMAIN=54.157.232.206");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.1.1710338911.38.1.1710339634.60.0.0; DOMAIN=54.157.232.206");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.1.1710338911.38.1.1710339648.46.0.0; DOMAIN=54.157.232.206");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.1.1710338911.38.1.1710339681.13.0.0; DOMAIN=54.157.232.206");
	...
	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710338910.42.1.1710339698.0.0.0; DOMAIN=54.157.232.206");

	lr_think_time(4);

	web_url("700309255_3", 
		"URL=http://54.157.232.206/order/api/v1/orders/history/lines/users/700309255", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=http://54.157.232.206/", 
	...
	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710338910.42.1.1710339699.0.0.0; DOMAIN=54.157.232.206");

	web_url("MyOrders-page.html", 
		"URL=http://54.157.232.206/app/account/views/MyOrders-page.html", 
		"TargetFrame=", 
		"Resource=0", 
		"Referer=http://54.157.232.206/", 
		"Snapshot=t14.inf", 
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.1.1710338911.38.1.1710339700.60.0.0; DOMAIN=54.157.232.206");
	...
	web_custom_request("4743769801", 
		"URL=http://54.157.232.206/order/api/v1/orders/history/users/700309255/4743769801", 
		"Method=DELETE", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
	...
	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1710338910.42.1.1710339750.0.0.0; DOMAIN=54.157.232.206");
