# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
...
Action()
{
    ...
    lr_start_transaction("UC8_ChangePassword");
    ...
    lr_end_transaction("Goto_AccountPage",2);
    ...
    web_add_cookie("_ga_56EMNRF2S2=GS1.1.1709640738.29.1.1709642249.24.0.0; DOMAIN={domain}");
    ...
    web_reg_save_param_xpath("ParamName=FullCountryName","QueryString=/SOAP-ENV:Envelope[1]/SOAP-ENV:Body[1]/ns2:GetAccountByIdNewResponse[1]/ns2:AccountResponse[1]/ns2:countryName[1]/text()[1]","ReturnXml=No","SEARCH_FILTERS","Scope=Body","LAST");
    ...
    web_add_cookie("_ga_56EMNRF2S2=GS1.1.1709640738.29.1.1709642262.11.0.0; DOMAIN={domain}");
    ...
    lr_end_transaction("Goto_AccountDetailsPage",2);
    ...
    web_add_cookie("_ga_56EMNRF2S2=GS1.1.1709640738.29.1.1709642310.44.0.0; DOMAIN={domain}");
    web_add_header("SOAPAction", "com.advantage.online.store.accountserviceChangePasswordRequest");
    
    web_reg_find("Text=Successfully","LAST");
    
    web_custom_request("ChangePasswordRequest",
        "URL={protocol}://{host}/accountservice/ws/ChangePasswordRequest",
        "Method=POST",
        "TargetFrame=",
        "Resource=0",
        "RecContentType=text/xml",
        ...
        "Mode=HTML",
        "EncType=text/xml; charset=UTF-8",
        "Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><ChangePasswordRequest xmlns=\"com.advantage.online.store.accountservice\"><accountId>{userId}</accountId><newPassword>{newPassword}</newPassword><oldPassword>{password}</oldPassword><base64Token>Basic {lpBase64}</base64Token></ChangePasswordRequest></soap:Body></soap:Envelope>",
        "LAST");

    web_add_header("SOAPAction", "com.advantage.online.store.accountserviceAccountUpdateRequest");

    web_reg_find("Text=Account updated successfully","LAST");
    
    web_custom_request("AccountUpdateRequest_2", 
        "URL={protocol}://{host}/accountservice/ws/AccountUpdateRequest", 
        "Method=POST", 
        "TargetFrame=", 
        "Resource=0", 
        "RecContentType=text/xml", 
        ...
        "Mode=HTML", 
        "EncType=text/xml; charset=UTF-8", 
        "Body=<?xml version=\"1.0\" encoding=\"UTF-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"><soap:Body><AccountUpdateRequest xmlns=\"com.advantage.online.store.accountservice\"><lastName>{lastName}</lastName><firstName>{firstName}</firstName><accountId>{userId}</accountId><countryId>{FullCountryName},{shortCountry}</countryId><stateProvince>{stateProvinceRegion}</stateProvince><cityName>{city}</cityName><address"
        ">{adress}</address><zipcode>{postalCode}</zipcode><phoneNumber>{phoneNumber}</phoneNumber><email>{email}</email><accountType>10</accountType><allowOffersPromotion>true</allowOffersPromotion><base64Token>Basic {lpBase64}</base64Token></AccountUpdateRequest></soap:Body></soap:Envelope>", 
        "LAST");
    ...
    lr_end_transaction("Entry_NewPassword",2);
    ...
    lr_end_transaction("UC8_ChangePassword",2);

    return 0;
}
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\uc8_changepassword\\\\combined_UC8_ChangePassword.c" 2
