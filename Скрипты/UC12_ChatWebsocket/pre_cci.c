# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
				  ...
				  int length)
{
		...
		if (isbinary) {
			...
			lr_save_string(data, "ReciveFromServer");
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
...
Action()
{
    ...
    if(strstr(lr_eval_string("{allpage}"),"HTTP/1.1 101") == 0) {
        lr_error_message("ќтвет от сервера при подключении вебсокета отличаетс€ от 101");
        lr_abort();
    }
    
    lr_end_transaction("Connect_Chat",2);
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"Hello, what's your name?") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"Is that really your name?") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"are you interested in a specific category of products?") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    web_websocket_send("ID={uniqNumber}", "Buffer=Yes", "IsBinary=0", "LAST");
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"Good, which category?") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"are you interested in a specific product from") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    web_websocket_send("ID={uniqNumber}", "Buffer=Yes", "IsBinary=0", "LAST");
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"Great, which product are you interested in?") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"leave me you phone number or e-mail and a specialized support person will contact you") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
    ...
    lr_think_time(3);
    if(strstr(lr_eval_string("{ReciveFromServer}"),"Thank you for contacting Advantage support") == 0) {
        lr_error_message("ѕодстрока не найдена в ответе от сервера");
         
    }
    
    lr_end_transaction("Entry_DataForChat",2);
    ...
    lr_end_transaction("Close_Chat",2);
    
    
    lr_end_transaction("UC12_ChatWebsocket",2);
    
    return 0;
}
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\uc12_chatwebsocket\\\\combined_UC12_ChatWebsocket.c" 2
