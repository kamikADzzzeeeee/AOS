# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
...
void productInCartAfterShop(char json[30000]) {
	...
	if (result == 0) {
    lr_error_message("РџСЂРѕРґСѓРєС‚ РЅРµ Р±С‹Р» РґРѕР±Р°РІР»РµРЅ РІ РєРѕСЂР·РёРЅСѓ");
    lr_abort();
    }
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
...
Action()
{
    ...
    lr_end_transaction("Goto_ShopCartPage",2);
    ...
    lr_end_transaction("Delete_ProductFromShopCart",2);
    ...
    lr_end_transaction("UC4_DeleteProductFromShopCart",2);

    return 0;
}
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\uc4_deleteproductfromshopcart\\\\combined_UC4_DeleteProductFromShopCart.c" 2
