# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c"
...
# 1 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
...
# 2 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
...
# 3 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
...
# 4 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
...
Action()
{
    ...
    lr_end_transaction("Goto_ShippingAndPaymentDetailsPage",2);
    ...
    if (atoi(lr_eval_string("{randomPayment}")) == 1) {
    	...
    	lr_end_transaction("Entry_PaymentData",2);
    } else {
        lr_start_transaction("Entry_PaymentData");
        if (count > 0) {
    ...
    lr_end_transaction("UC5_PaymentForProducts",2);

    return 0;
}
# 5 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
...
# 6 "c:\\users\\user\\documents\\vugen\\scripts\\uc5_paymentforproducts\\\\combined_UC5_PaymentForProducts.c" 2
